...
setup(
    ...
    package_data={},
    install_requires=[
        'bokeh==2.2.2; python_version >= "3.6"',
        ...
        'eve==1.1.3; python_version != "3.0.*" and python_version != "3.1.*" and python_version != "3.2.*" and python_version != "3.3.*" and python_version != "3.4.*" and python_version >= "2.7"',
        'events==0.3',
        ...
        'immutables==0.14; python_version < "3.7" and python_version >= "3.5"',
        ...
        'markdown==3.3.1; python_version >= "3.6"',
        ...
        'param==1.9.3; python_version >= "2.7"',
        ...
        'tqdm==4.50.2; python_version != "3.0.*" and python_version != "3.1.*" and python_version >= "2.6"',
        ...
        'zipp==1.2.0; python_version < "3.8" and python_version >= "2.7"'
    ],
    extras_require={
        "dev": [
            ...
            "importlib-resources==3.0.0; python_version < \"3.7\" and python_version != \"3.0.*\" and python_version != \"3.1.*\" and python_version != \"3.2.*\" and python_version != \"3.3.*\" and python_version != \"3.4.*\" and python_version >= \"2.7\"",
            "iniconfig==1.0.1", "invoke==1.4.1",
            ...
            "pytest==6.1.1; python_version >= \"3.5\"", "pytz==2020.1",
            ...
            "urllib3==1.22",
            "virtualenv==20.0.34; python_version != \"3.0.*\" and python_version != \"3.1.*\" and python_version != \"3.2.*\" and python_version != \"3.3.*\" and python_version >= \"2.7\"",
